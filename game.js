...
function getRandomInt(max){
    return Math.floor(Math.random()*max);//creates a random number between 0 and max //Math.floor rounds the number up
}
...
function moveBees() { //get speed input field value
